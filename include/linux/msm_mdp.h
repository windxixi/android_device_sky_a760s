...
#define MSMFB_SKY_VEIL_ENABLE       _IOW(MSMFB_IOCTL_MAGIC, 150,   struct msmfb_veil_view)
#define MSMFB_SKY_VEIL_SET          _IOW(MSMFB_IOCTL_MAGIC, 151,   struct msmfb_veil_view)
#endif
...
#define MSMFB_SKY_LCD_GAMMA_SET		_IOW(MSMFB_IOCTL_MAGIC, 154, unsigned int)
#endif
